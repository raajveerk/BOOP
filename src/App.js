  ...
  return (
    <div className="wrapper w-full m-0">
      ...
      <div className='relative wrapperForParallax flex justify-center'>
        ...
        <div className='absolute w-[650px] h-[450px] top-[0px] right-[-700px] md:top-[50px] md:right-[-535px] lg:top-[-220px] lg:right-[-835px] opacity-60 bg-contain bg-blend-soft-light bg-scroll bg-no-repeat blobUno'></div>
        ...
        <div className='absolute w-[250px] h-[250px] top-[780px] right-[-125px] md:top-[1050px] md:right-[-145px] lg:top-[925px] lg:right-[-165px] bg-cover bg-scroll bg-no-repeat rocket'></div>
