  ...
  return (
    <div className="wrapper w-full m-0">
      ...
      <div className='relative wrapperForParallax flex justify-center'>
        ...
        <div className='absolute w-[650px] h-[450px] top-[-100px] right-[-700px] md:top-[50px] md:right-[-535px] lg:top-[-220px] lg:right-[-835px] opacity-60 bg-contain bg-blend-soft-light bg-scroll bg-no-repeat blobUno'></div>
        {/* <div className='absolute w-[450px] h-[450px] top-[3750px] right-[-135px] bg-contain bg-scroll bg-no-repeat line'></div> */}
        <div className='absolute w-[250px] h-[250px] top-[-150px] left-[-200px] lg:top-[30px] lg:left-[-395px] bg-cover bg-scroll bg-no-repeat moon'></div>
        <div className='absolute w-[250px] h-[250px] top-[850px] right-[-125px] md:top-[1050px] md:right-[-145px] lg:top-[925px] lg:right-[-165px] bg-cover bg-scroll bg-no-repeat rocket'></div>
        ...
        <div className='absolute top-[1850px] right-[-250px] md:top-[2165px] md:left-[50px] lg:top-[1865px] lg:left-[380px] bg-gradient-to-br from-grad-uno via-grad-dos to-grad-tres w-[550px] h-[450px] blobBackground blur-3xl opacity-70'></div>
